...
<nav class="fixed top-16 left-0 w-full bg-gradient-to-b from-green-800 via-green-700 to-green-800 shadow-sm z-[45]">
    ...
    <div class="lg:hidden block">
      <!-- Hamburger Button (This should be in your header component) -->
      <!-- Mobile Sidebar Menu -->
      <Transition
...
const servicesData = ref([
  ...
  {
    title: 'Try at Home',
    description: 'Try up to 5 designs from the comfort of your home.',
  ...
  {
    title: 'Video Call',
    description: 'Buy jewellery LIVE on video call by booking an appointment.',
    iconBg: 'bg-green-500',
    iconComponent: () => h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
